# This Makefile is for the vagrant extension to perl.
#
...
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => {  }
#     PREREQ_PM => { Text::Upskirt=>q[0], Getopt::Long=>q[0], Email::Send::Gmail=>q[0], Email::Send=>q[0], Store::CouchDB=>q[2.8], common::sense=>q[0], Data::Dumper=>q[0], JSON=>q[0], MIME::EncWords=>q[0], WWW::Facebook::API=>q[0], Config::Tiny=>q[0], File::Util=>q[0], Digest::SHA=>q[0], File::Path=>q[0], MIME::Lite=>q[0], Mojolicious=>q[2.95] }
#     TEST_REQUIRES => {  }
#     VERSION => q[0.01]
#     test => { TESTS=>q[t/*.t] }
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name: vagrant' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '  Email::Send: 0' >> META_new.yml
	$(NOECHO) $(ECHO) '  Email::Send::Gmail: 0' >> META_new.yml
	$(NOECHO) $(ECHO) '  File::Path: 0' >> META_new.yml
	$(NOECHO) $(ECHO) '  File::Util: 0' >> META_new.yml
	$(NOECHO) $(ECHO) '  Getopt::Long: 0' >> META_new.yml
	$(NOECHO) $(ECHO) '  JSON: 0' >> META_new.yml
	$(NOECHO) $(ECHO) '  MIME::EncWords: 0' >> META_new.yml
	$(NOECHO) $(ECHO) '  MIME::Lite: 0' >> META_new.yml
	$(NOECHO) $(ECHO) '  Mojolicious: 2.95' >> META_new.yml
	$(NOECHO) $(ECHO) '  Store::CouchDB: 2.8' >> META_new.yml
	$(NOECHO) $(ECHO) '  Text::Upskirt: 0' >> META_new.yml
	$(NOECHO) $(ECHO) '  WWW::Facebook::API: 0' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "vagrant",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '            "Email::Send" : "0",' >> META_new.json
	$(NOECHO) $(ECHO) '            "Email::Send::Gmail" : "0",' >> META_new.json
	$(NOECHO) $(ECHO) '            "File::Path" : "0",' >> META_new.json
	$(NOECHO) $(ECHO) '            "File::Util" : "0",' >> META_new.json
	$(NOECHO) $(ECHO) '            "Getopt::Long" : "0",' >> META_new.json
	$(NOECHO) $(ECHO) '            "JSON" : "0",' >> META_new.json
	$(NOECHO) $(ECHO) '            "MIME::EncWords" : "0",' >> META_new.json
	$(NOECHO) $(ECHO) '            "MIME::Lite" : "0",' >> META_new.json
	$(NOECHO) $(ECHO) '            "Mojolicious" : "2.95",' >> META_new.json
	$(NOECHO) $(ECHO) '            "Store::CouchDB" : "2.8",' >> META_new.json
	$(NOECHO) $(ECHO) '            "Text::Upskirt" : "0",' >> META_new.json
	$(NOECHO) $(ECHO) '            "WWW::Facebook::API" : "0",' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Email::Send" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Email::Send::Gmail" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="File::Path" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="File::Util" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Getopt::Long" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="JSON::" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="MIME::EncWords" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="MIME::Lite" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE VERSION="2.95" NAME="Mojolicious::" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Store::CouchDB" VERSION="2.8" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Text::Upskirt" />' >> $(DISTNAME).ppd
